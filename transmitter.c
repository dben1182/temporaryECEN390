...
void transmitter_init()
{
    ...
    //*************************************************************************************//
    /////////////////////////////////////////////////////////////////////////////////////////
    //sets the currentFrequencyNumber and nextFrequencyNumbers to be player 1 number, which is
    //zero. Theoretically, those numbers will be updated outside of this function, but we may need
    //to be safe at least to initialize those values, so we don't accidentally get whatever left
    //over garbage is in 
...
{
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //may need to change this number so that we don't have to use this offset of 1, because otherwise, we get one
    //too many ticks
